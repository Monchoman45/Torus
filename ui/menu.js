...
Torus.ui.menu.render = function() {
	var name = document.createElement('div');
		...
		name.textContent = Torus.i18n.text('menu-torus', Torus.pretty_version);
	...
	var links = document.createElement('div');
		...
		var github = document.createElement('a');
			...
			github.textContent = Torus.i18n.text('menu-fork');
		...
		var report = document.createElement('a');
			...
			report.textContent = Torus.i18n.text('menu-report');
		...
		var doc = document.createElement('a');
			...
			doc.textContent = Torus.i18n.text('menu-doc');
